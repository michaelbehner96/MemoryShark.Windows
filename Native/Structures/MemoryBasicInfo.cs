...
public struct MemoryBasicInformation
{
    ...
    /// </summary>
    /// <remarks>
    ///     This member can be one of the <see cref="MemoryProtectionFlags" /> constants or 0 if the caller does not have
    ///     access.
    /// </remarks>
    [FieldOffset(16)]
    ...
    /// <summary>
    ///     The size of the region (in bytes), beginning at the <see cref="BaseAddress">BaseAddress</see> in which all pages
