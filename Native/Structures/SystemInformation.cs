...
///     This includes the architecture and type of the processor, the number of processors in the system, the page size,
...
public struct SystemInformation
{
    ...
    /// </summary>
    /// <remarks>
    ///     This is the page size used by
    ///     <see cref="WindowsPinvoke.VirtualAllocEx(IntPtr, IntPtr, UIntPtr, AllocationTypeFlags, MemoryProtectionFlags)">VirtualAllocEx</see>
    ///     .
    /// </remarks>
